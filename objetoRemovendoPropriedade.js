...
const removerPropriedade = (objeto, propriedadeARemover) => { 
    copyObject = Object.assign({}, objeto) ///aqui voce copia o objeto
    // copyObject = Object.create(objeto, {}) ///aqui voce copia o objeto
    delete copyObject[propriedadeARemover]//usei outra forma de acessar objeto
    return copyObject
    
  

}
console.log(removerPropriedade({a: 1, b: 2,antonio: "E LIndo"}, "a"))
