...
const inverter = inversao => { 
    const objetosTruncados = Object.entries(inversao)
    objetosTruncados.forEach((elemento) => elemento.reverse())
    const inverso = Object.fromEntries(objetosTruncados)
    return inverso
}
